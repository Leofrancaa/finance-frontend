  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-6 h-6 lg:w-8 lg:h-8 text-blue-500 transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] drop-shadow-[0_2px_4px_rgba(0,0,0,0.1)] group-hover:rotate-[-15deg] group-hover:scale-110 group-active:rotate-[-5deg] group-active:scale-95"
      >
